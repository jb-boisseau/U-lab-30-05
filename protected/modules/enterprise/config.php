...
return [
    ...
    'events' => [
        ...
        ['class' => 'humhub\modules\space\widgets\SpaceChooserItem', 'event' => Widget::EVENT_CREATE, 'callback' => ['humhub\modules\enterprise\modules\spacetype\Module', 'onSpaceChooserItemCreate']],
        // Account
        ...
        ['class' => 'humhub\modules\user\controllers\ImageController', 'event' => 'init', 'callback' => ['humhub\modules\enterprise\modules\ldap\Module', 'onUserImageControllerInit']],
        // JWT
