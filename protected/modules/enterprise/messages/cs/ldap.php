...
return [
    ...
    '<strong>Create</strong> new ldap mapping' => '<strong>Vytvořte </strong> nové ldap mapování',
    '<strong>Edit</strong> ldap mapping' => '<strong>Upravit</strong> ldap mapovaní',
    '<strong>LDAP</strong> member mapping' => '<strong>LDAP</strong> mapovaní členů',
    'Create new mapping' => 'Vytvořit nové mapování',
    'Group' => 'Skupina',
    'ID' => 'ID',
    'LDAP' => 'LDAP',
    'LDAP Mapping' => 'mapovaní LDAP ',
