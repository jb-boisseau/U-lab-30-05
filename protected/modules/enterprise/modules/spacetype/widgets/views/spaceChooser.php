...
/**
 * This view only extends the default space chooser with a space type badge and project create buttons.
 */
...
<?php if (count($createSpaceTypes) !== 0): ?>
    <li>
        <div class="dropdown-footer">
            ...
            <a href="#" class="btn btn-info btn-sm" data-action-click="ui.modal.load" data-action-url="<?= Url::to(['/enterprise/spacetype/create-space/create', 'type_id' => $type->id]) ?>">
